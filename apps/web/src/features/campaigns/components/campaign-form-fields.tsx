...
// Feature-local wrapper, same pattern as `features/animals/components/animal-form-fields.tsx`
// and `features/org/components/profile-fields.tsx` (duplicated per-feature, not shared).
