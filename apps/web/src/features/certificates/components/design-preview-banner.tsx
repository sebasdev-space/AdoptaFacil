...
export function DesignPreviewBanner({ detail }: DesignPreviewBannerProps) {
  return (
    <div
      ...
      role="note"
      className="flex flex-wrap items-center gap-x-3 gap-y-1 rounded-md border border-dashed border-warning/50 bg-warning/10 px-3 py-2 text-sm text-foreground"
    >
