...
/**
 * Feature-local icon set (S2-04A). `shell/icons.tsx` is Fabián's (nav/shell);
 * these are specific to the Animals card grid/modal, so they live here rather
 * than growing the shared set without his review — same shape/convention
 * (inherits `currentColor`, decorative only).
 */
